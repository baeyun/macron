...
class MacronWebview:
  def __init__(self, config):
    ...
    self.webview.load_uri("http://pointlessramblings.com/posts/Why_Always_Electron/")
    ...
    self.webview.get_settings().set_allow_modal_dialogs(False)    # https://bugzilla.mozilla.org/show_bug.cgi?id=194404
    self.webview.get_settings().set_auto_load_images(True)
    print("settings.get_default_charset():", self.webview.get_settings().get_default_charset())
    # self.webview.get_settings().set_accelerated_2d_canvas(False)     
    self.webview.get_settings().set_enable_caret_browsing(False)     
    # self.webview.get_settings().set_developer_extras(True)           
    ...
    # self.webview.get_settings().set_enable_running_of_insecure_content(False)
    # self.webview.get_settings().set_enable_scripts(False)             
